...
function C:update(data)
	...
	local car_direction_vectors            = {x=car_direction_vector_leftward, y=car_direction_vector_backward, z=car_direction_vector_upward}
	...
	local camera_direction_vectors         = {x=camera_direction_vector_leftward, y=camera_direction_vector_backward, z=camera_direction_vector_upward}
